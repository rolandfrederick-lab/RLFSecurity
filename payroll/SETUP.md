...
5. Send workers the app address. Each one creates an account, then waits.
6. More, People and roles: for each new person, pick the role, link them to their worker record, and tick approved.
